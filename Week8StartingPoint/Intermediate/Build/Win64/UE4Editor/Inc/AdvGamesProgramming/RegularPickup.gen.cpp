...
// Cross Module References
	ADVGAMESPROGRAMMING_API UEnum* Z_Construct_UEnum_AdvGamesProgramming_PickupRarity();
...
// End Cross Module References
	static UEnum* PickupRarity_StaticEnum()
	{
		static UEnum* Singleton = nullptr;
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_AdvGamesProgramming_PickupRarity, Z_Construct_UPackage__Script_AdvGamesProgramming(), TEXT("PickupRarity"));
		}
		return Singleton;
	}
	template<> ADVGAMESPROGRAMMING_API UEnum* StaticEnum<PickupRarity>()
	{
		return PickupRarity_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_PickupRarity(PickupRarity_StaticEnum, TEXT("/Script/AdvGamesProgramming"), TEXT("PickupRarity"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_AdvGamesProgramming_PickupRarity_Hash() { return 2543916345U; }
	UEnum* Z_Construct_UEnum_AdvGamesProgramming_PickupRarity()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_AdvGamesProgramming();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("PickupRarity"), 0, Get_Z_Construct_UEnum_AdvGamesProgramming_PickupRarity_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "PickupRarity::LEGENDARY", (int64)PickupRarity::LEGENDARY },
				{ "PickupRarity::MASTER", (int64)PickupRarity::MASTER },
				{ "PickupRarity::RARE", (int64)PickupRarity::RARE },
				{ "PickupRarity::COMMON", (int64)PickupRarity::COMMON },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "Comment", "/**\n * \n */" },
				{ "COMMON.Comment", "/**\n * \n */" },
				{ "COMMON.Name", "PickupRarity::COMMON" },
				{ "LEGENDARY.Comment", "/**\n * \n */" },
				{ "LEGENDARY.Name", "PickupRarity::LEGENDARY" },
				{ "MASTER.Comment", "/**\n * \n */" },
				{ "MASTER.Name", "PickupRarity::MASTER" },
				{ "ModuleRelativePath", "RegularPickup.h" },
				{ "RARE.Comment", "/**\n * \n */" },
				{ "RARE.Name", "PickupRarity::RARE" },
			};
#endif
	...
	IMPLEMENT_CLASS(ARegularPickup, 1056029156);
